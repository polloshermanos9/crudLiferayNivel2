...
public class LibroModelImpl extends BaseModelImpl<Libro> implements LibroModel {
	...
	public static final String ORDER_BY_SQL = " ORDER BY LIBRO_Libro.titulo ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.libro.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.libro.model.Libro"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.training.libro.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.libro.model.Libro"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.training.libro.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.libro.model.Libro"), true);
	...
	public static final boolean FINDER_CACHE_ENABLED_LIBRO_LIBROS_ESCRITORES = GetterUtil.getBoolean(com.liferay.training.libro.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.LIBRO_Libros_Escritores"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.training.libro.service.util.ServiceProps.get(
				"lock.expiration.time.libro.model.Libro"));
