...
import libro.model.impl.EscritorModelImpl;
 ...
 * @see libro.service.persistence.EscritorUtil
 * @generated
 */
@ProviderType
public class EscritorPersistenceImpl extends BasePersistenceImpl<Escritor>
	 ...
	 */
	@Override
	public List<libro.model.Libro> getLibros(long pk) {
	 ...
	 */
	@Override
	public List<libro.model.Libro> getLibros(long pk, int start, int end) {
	...
	@Override
	public List<libro.model.Libro> getLibros(long pk, int start, int end,
		OrderByComparator<libro.model.Libro> orderByComparator) {
	 ...
	 */
	@Override
	public void addLibro(long pk, libro.model.Libro libro) {
		Escritor escritor = fetchByPrimaryKey(pk);
	 ...
	 */
	@Override
	public void addLibros(long pk, List<libro.model.Libro> libros) {
		addLibros(pk,
			ListUtil.toLongArray(libros, libro.model.Libro.LIBRO_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void removeLibro(long pk, libro.model.Libro libro) {
	 ...
	 */
	@Override
	public void removeLibros(long pk, List<libro.model.Libro> libros) {
		removeLibros(pk,
			ListUtil.toLongArray(libros, libro.model.Libro.LIBRO_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void setLibros(long pk, List<libro.model.Libro> libros) {
		try {
			long[] libroPKs = new long[libros.size()];

			for (int i = 0; i < libros.size(); i++) {
				libro.model.Libro libro = libros.get(i);
	...
	protected TableMapper<Escritor, libro.model.Libro> escritorToLibroTableMapper;
