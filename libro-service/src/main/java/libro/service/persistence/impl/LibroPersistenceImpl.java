...
package libro.service.persistence.impl;
...
import libro.model.impl.LibroModelImpl;

import libro.service.persistence.EscritorPersistence;
import libro.service.persistence.LibroPersistence;
 ...
 * @see libro.service.persistence.LibroUtil
 * @generated
 */
@ProviderType
public class LibroPersistenceImpl extends BasePersistenceImpl<Libro>
	...
	protected Libro removeImpl(Libro libro) {
		...
		libroToEscritorTableMapper.deleteLeftPrimaryKeyTableMappings(libro.getPrimaryKey());
	 ...
	 */
	@Override
	public List<libro.model.Escritor> getEscritors(long pk) {
	 ...
	 */
	@Override
	public List<libro.model.Escritor> getEscritors(long pk, int start, int end) {
	...
	@Override
	public List<libro.model.Escritor> getEscritors(long pk, int start, int end,
		OrderByComparator<libro.model.Escritor> orderByComparator) {
		return libroToEscritorTableMapper.getRightBaseModels(pk, start, end,
			orderByComparator);
	}
	...
	public void addEscritor(long pk, long escritorPK) {
		...
		if (libro == null) {
			libroToEscritorTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, escritorPK);
		}
		else {
			libroToEscritorTableMapper.addTableMapping(libro.getCompanyId(),
				pk, escritorPK);
		}
	}
	 ...
	 */
	@Override
	public void addEscritor(long pk, libro.model.Escritor escritor) {
		Libro libro = fetchByPrimaryKey(pk);
	 ...
	 */
	@Override
	public void addEscritors(long pk, List<libro.model.Escritor> escritors) {
		addEscritors(pk,
			ListUtil.toLongArray(escritors,
				libro.model.Escritor.ESCRITOR_ID_ACCESSOR));
	}
	 ...
	 */
	@Override
	public void removeEscritor(long pk, libro.model.Escritor escritor) {
		libroToEscritorTableMapper.deleteTableMapping(pk,
	 ...
	 */
	@Override
	public void removeEscritors(long pk, List<libro.model.Escritor> escritors) {
		removeEscritors(pk,
			ListUtil.toLongArray(escritors,
				libro.model.Escritor.ESCRITOR_ID_ACCESSOR));
	}
	...
	public void setEscritors(long pk, long[] escritorPKs) {
		...
		Set<Long> oldEscritorPKsSet = SetUtil.fromArray(libroToEscritorTableMapper.getRightPrimaryKeys(
					pk));
		...
		libroToEscritorTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeEscritorPKsSet));
		...
		libroToEscritorTableMapper.addTableMappings(companyId, pk,
			ArrayUtil.toLongArray(newEscritorPKsSet));
	}
	 ...
	 */
	@Override
	public void setEscritors(long pk, List<libro.model.Escritor> escritors) {
		try {
			long[] escritorPKs = new long[escritors.size()];

			for (int i = 0; i < escritors.size(); i++) {
				libro.model.Escritor escritor = escritors.get(i);
	...
	public void afterPropertiesSet() {
		libroToEscritorTableMapper = TableMapperFactory.getTableMapper("LIBRO_Libros_Escritores",
				"companyId", "libroId", "escritorId", this, escritorPersistence);
	}
	...
	protected TableMapper<Libro, libro.model.Escritor> libroToEscritorTableMapper;
