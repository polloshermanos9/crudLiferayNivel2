 ...
 * @see LibroModel
 * @see libro.model.impl.LibroImpl
 * @see libro.model.impl.LibroModelImpl
 * @generated
 */
@ImplementationClassName("libro.model.impl.LibroImpl")
@ProviderType
public interface Libro extends LibroModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link libro.model.impl.LibroImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
