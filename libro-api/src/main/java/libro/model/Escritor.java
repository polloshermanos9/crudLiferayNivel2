 ...
 * @generated
 */
@ImplementationClassName("libro.model.impl.EscritorImpl")
@ProviderType
public interface Escritor extends EscritorModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link libro.model.impl.EscritorImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
