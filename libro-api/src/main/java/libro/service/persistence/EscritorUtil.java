...
package libro.service.persistence;
 ...
 * @see libro.service.persistence.impl.EscritorPersistenceImpl
 * @generated
 */
@ProviderType
public class EscritorUtil {
	...
	*/
	public static Escritor findByUuid_First(java.lang.String uuid,
		OrderByComparator<Escritor> orderByComparator)
		throws libro.exception.NoSuchEscritorException {
	...
	*/
	public static List<libro.model.Libro> getLibros(long pk) {
	...
	*/
	public static List<libro.model.Libro> getLibros(long pk, int start, int end) {
	...
	*/
	public static List<libro.model.Libro> getLibros(long pk, int start,
		int end, OrderByComparator<libro.model.Libro> orderByComparator) {
	...
	*/
	public static void addLibro(long pk, libro.model.Libro libro) {
	...
	*/
	public static void addLibros(long pk, List<libro.model.Libro> libros) {
	...
	* @param libro the libro
	*/
	public static void removeLibro(long pk, libro.model.Libro libro) {
	...
	* @param libros the libros
	*/
	public static void removeLibros(long pk, List<libro.model.Libro> libros) {
	...
	*/
	public static void setLibros(long pk, List<libro.model.Libro> libros) {
