...
public interface EscritorPersistence extends BasePersistence<Escritor> {
	...
	*/
	public java.util.List<libro.model.Libro> getLibros(long pk);
	...
	*/
	public java.util.List<libro.model.Libro> getLibros(long pk, int start,
		int end);
	...
	*/
	public void addLibros(long pk, java.util.List<libro.model.Libro> libros);
	...
	* @param libros the libros
	*/
	public void removeLibros(long pk, java.util.List<libro.model.Libro> libros);
	...
	*/
	public void setLibros(long pk, java.util.List<libro.model.Libro> libros);
