 ...
 * @see libro.service.persistence.impl.LibroPersistenceImpl
 * @generated
 */
@ProviderType
public class LibroUtil {
	...
	*/
	public static Libro findByUuid_First(java.lang.String uuid,
		...
		throws libro.exception.NoSuchLibroException {
	...
	*/
	public static List<libro.model.Escritor> getEscritors(long pk) {
	...
	*/
	public static List<libro.model.Escritor> getEscritors(long pk, int start,
		int end) {
	...
	*/
	public static List<libro.model.Escritor> getEscritors(long pk, int start,
		int end, OrderByComparator<libro.model.Escritor> orderByComparator) {
	...
	*/
	public static void addEscritor(long pk, libro.model.Escritor escritor) {
	...
	*/
	public static void addEscritors(long pk,
		List<libro.model.Escritor> escritors) {
	...
	* @param escritor the escritor
	*/
	public static void removeEscritor(long pk, libro.model.Escritor escritor) {
